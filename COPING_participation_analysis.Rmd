...
The first plots from the car package visualise Cook's distance as well as 
studentized residuals and outlier significance levels

Cook's distance values > 0.5 are worth investigating and > 1 are a real cause for concern

```{r Check for outliers in the complete MLR model}

influenceIndexPlot(sociodemographic_MLR_model)
