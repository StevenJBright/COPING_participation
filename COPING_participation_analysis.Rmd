...
#Exploratory model - Saliva kit

This is a post-hoc model to investigate whether sociodemographic, mental, and
physical health variables are associated with providing a saliva kit for the
GLAD Study. This model was introduced because Molly raised the point that 
whilst providing a saliva kit was used as an explanatory variable for aim 1,
it is somewhat circular because it is a measure of participation.

```{r Exploratory LR model - providing a saliva kit for the GLAD Study}

saliva_kit_LR_model <- glm(
